...
$string['scheduled_task_delete_questions_smallmessage'] = 'StudentQuiz: Task to delete orphaned questions has run';
$string['scheduled_task_delete_questions_subject'] = 'StudentQuiz';
$string['scheduled_task_delete_questions'] = 'Delete orphaned questions';
$string['scheduled_task_delete_questions_error_mdlquestion'] = '<font color="red">error</font>: could not delete from mdl_question table. The question probably is in use somewhere.<br><font color="red">error</font>: delete from mdl_studentquiz* tables has been skipped.<br>';
$string['scheduled_task_delete_questions_error_studentquiz'] = '<font color="red">error</font>: could not delete from mdl_studentquiz* tables.<br>';
$string['scheduled_task_delete_questions_fullmessage'] = 'Questions that are disapproved/flagged for deletion:<ul>{$a->fullmessage}</ul>';
$string['scheduled_task_delete_questions_none_found'] = '<b>none found</b>';
$string['scheduled_task_delete_questions_questioninfo'] = '<li><b>{$a->name}</b> (Questiontype: {$a->qtype}, ID: {$a->questionid})</li>';
$string['scheduled_task_delete_questions_success_mdlquestion'] = '<font color="green">success</font>: deleted from mdl_question table<br>';
$string['scheduled_task_delete_questions_success_studentquiz'] = '<font color="green">success</font>: deleted from mdl_studentquiz* tables.<br>';
...
$string['settings_deleteorphaned'] = 'Delete orphaned questions';
$string['settings_deleteorphaned_help'] = 'Activates a scheduled task that will run every day to delete all orphaned/not approved questions from the database.';
