...
$string['scheduled_task_delete_orphaned_questions_smallmessage'] = 'StudentQuiz: Task to delete orphaned questions has run';
$string['scheduled_task_delete_orphaned_questions_subject'] = 'StudentQuiz';
$string['scheduled_task_delete_orphaned_questions'] = 'Delete orphaned questions';
